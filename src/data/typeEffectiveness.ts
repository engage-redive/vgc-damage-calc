...
export const typeEffectiveness: Record<PokemonType, Record<PokemonType, number>> = {
    ...
    ghost: { psychic: 2, ghost: 2, dark: 0.5, normal: 0, fighting: 1, fire: 1, water: 1, electric: 1, grass: 1, ice: 1, poison: 1, ground: 1, flying: 1, bug: 1, rock: 1, steel: 1, dragon: 1, fairy: 1 },
